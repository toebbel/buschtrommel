...
public class MainFrame extends javax.swing.JFrame implements IGUICallbacks {
    ...
    private FilesTableModel tablemodell = new FilesTableModel();
    ...
    public MainFrame() {
        ...
        filesHostsTable.setModel(tablemodell);
    ...
    private void initComponents() {
        ...
        filesHostsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
    ...
    public void hostWentOffline(Host host) {
        tablemodell.hostWentOffline(host);
        //throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public void removeShare(ShareAvailability file) {
        tablemodell.removeShare(file);
        //throw new UnsupportedOperationException("Not supported yet.");
    }
