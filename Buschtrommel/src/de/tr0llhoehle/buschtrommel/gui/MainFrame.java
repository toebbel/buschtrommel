...
public class MainFrame extends javax.swing.JFrame implements IGUICallbacks {
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(downloadFolder, javax.swing.GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	private void viewFilelistTransfersBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewFilelistTransfersBoxActionPerformed
		...
		viewFilelistTransfersBox.setSelected(Config.showFileListTransfers);
		LoggerWrapper.logInfo("View Filelist Transfers = " + Config.showFileListTransfers);
	...
	private void selectDownloadFolderActionPerformed(ActionEvent evt) {
		...
		if (returnVal == pathChooser.APPROVE_OPTION) {
			...
			Config.defaultDownloadFolder = file.getAbsolutePath();
			downloadFolder.setText(Config.defaultDownloadFolder);
	...
	private void addShareActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addShareActionPerformed
		...
		if (returnVal == jFileChooser1.APPROVE_OPTION) {
			...
			sharesModel.addShare(file.getName(), file.getAbsolutePath(), size, String.valueOf(Config.defaultTTL));
			// System.out.println(file.getAbsolutePath());
			// System.out.println( new FileReader( file.getAbsolutePath() ),
			// null );
			// } catch (IOException ex) {
