...
public class Host {
	...
	public Hashtable<String, File> getSharedFiles() {
		return (Hashtable<String, File>) shares.clone();
	}
	 ...
	 */
	public void addFileToSharedFiles(File f) {
		LoggerWrapper.logInfo("Add file '" + f + "' to " + this.toString());
		shares.put(f.getHash(), f);
	}
